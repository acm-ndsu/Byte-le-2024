...
class TestGameBoard(unittest.TestCase):
    ...
    def test_add_trap(self):
        ...
        trap_queue.add_trap(Landmine(inventory_manager=InventoryManager(), owner_company=Company.CHURCH,
                                     target_company=Company.TURING, opponent_position=lambda : Vector(),
                                     position=Vector()))
