...
class TestDynamiteController(unittest.TestCase):
    ...
    def test_no_explosion(self):
        ...
        self.assertTrue(self.world.game_map[self.avatar.position.y][self.avatar.position.x].is_occupied_by(
            ObjectType.DYNAMITE))
    ...
    def test_explosion(self):
        ...
        self.assertTrue(self.world.game_map[1][1].is_occupied_by(ObjectType.DYNAMITE) and
                        self.world.game_map[1][1].is_occupied_by(ObjectType.AVATAR))
        self.assertTrue(self.world.game_map[0][1].is_occupied_by(ObjectType.COPIUM_OCCUPIABLE_STATION))  # up tile
        self.assertTrue(self.world.game_map[1][2].is_occupied_by(ObjectType.TURITE_OCCUPIABLE_STATION))  # right tile
        self.assertTrue(self.world.game_map[2][1].occupied_by is None)  # down tile
        self.assertTrue(self.world.game_map[1][0].is_occupied_by(ObjectType.COPIUM_OCCUPIABLE_STATION) and  # left tile
                        self.world.game_map[1][0].is_occupied_by(ObjectType.TURITE_OCCUPIABLE_STATION))
