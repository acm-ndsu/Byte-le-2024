...
class TestMineController(unittest.TestCase):
    ...
    def test_mining(self):
        ...
        self.assertTrue(self.world.game_map[1][1].is_occupied_by_objcet_type(ObjectType.AVATAR) and not
        self.world.game_map[1][1].is_occupied_by_objcet_type(ObjectType.ANCIENT_TECH_OCCUPIABLE_STATION))
